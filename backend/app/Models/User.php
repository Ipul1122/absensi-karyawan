...
#[Fillable(['name', 'email', 'whatsapp', 'password', 'role', 'password_plain', 'photo', 'date_of_birth', 'address', 'employee_number', 'join_date', 'gender', 'division', 'cv', 'status', 'no_rekening', 'company'])]
