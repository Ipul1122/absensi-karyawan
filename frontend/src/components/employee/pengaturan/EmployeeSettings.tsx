...
export default function EmployeeSettings({ user, token }: EmployeeSettingsProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
      ...
      <div className="flex items-center gap-3 p-4 bg-blue-50 border border-blue-200 rounded-2xl text-blue-900 shadow-sm">
        <Info className="w-5 h-5 shrink-0 text-blue-600" />
        <div className="text-xs font-semibold font-quicksand leading-relaxed">
          Data biodata (nama, email, divisi, dll.) hanya dapat diubah oleh <strong>Administrator</strong>. Anda hanya dapat mengganti foto profil, mengunggah CV, dan memperbarui kata sandi.
        </div>
      </div>
        ...
        <section className="bg-white border border-orange-100 rounded-3xl p-6 shadow-sm space-y-5 animate-fade-in">
          ...
          {loadingProfile ? (
            ...
            <div className="space-y-5">
              ...
              {/* ---- Photo Upload (employee tetap bisa ganti foto) ---- */}
              ...
              <div className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl">
                ...
                <p className="text-[11px] text-slate-500 font-quicksand">Data di bawah ini hanya dapat diubah oleh <strong className="text-slate-700">Administrator</strong>. Hubungi admin untuk pembaruan data.</p>
              </div>
              ...
              {/* ---- CV Upload (employee tetap bisa upload CV) ---- */}
              <div>
